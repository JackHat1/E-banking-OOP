...
public class DepositPanel extends JPanel {
    public DepositPanel(User user, AccountManager accountManager) {
        ...
        // === Ενημέρωση υπολοίπου όταν αλλάζει επιλογή ===
        ...
        depositBtn.addActionListener(e -> {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "✅ Κατατέθηκαν " + amount + "€ στον " + selected.getIban());
                amountField.setText("");
                balanceLabel.setText("Υπόλοιπο: " + String.format("%.2f €", selected.getBalance())); // update after deposit
